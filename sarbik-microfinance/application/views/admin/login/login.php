...
<head>
  ...
  <title> RAUD-SARBIK| Log in</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>admin_asset/css/cus-style.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url() ?>admin_asset/admin_login"><b>IDB Microfinance</b></a>
    <p>A Product Of <b>IsDB-BISEW</b></p>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>
                ...
                if ($message) {
                    ?>
                    <div class="alert alert-success" style="color:yellow;font-size: 25px">
                        <?php echo $message; ?>
                    </div>
                    <?php
    ...
    <form action="<?php echo base_url() ?>admin_login/check_login" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="admin_email_address" class="form-control" placeholder="Email">
