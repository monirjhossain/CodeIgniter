...
<?php
   ...
   <form  method="POST" action="<?php echo base_url() ?>super_admin/saveGovtHolyDayCalender" enctype="multipart/form-data">
    <div class="box-body">
	    ...
	    <div class="form-group">
           ...
           <select name="year"  class="form-control">
				...
				<option value=""> <?php echo $year+1;?> </option> 
                ...
                foreach ($listHolyDay as $v_content) {
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td>
                            ...
                            <a href="<?php echo base_url() ?>super_admin/editHolyDay/<?php echo $v_content->date_id; ?>" class="<?php if($sessionUserDetails->admin_type=='field_officer'){echo ' hide';}?>">
