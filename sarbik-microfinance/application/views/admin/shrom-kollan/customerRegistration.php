...
<div class="box box-primary <?php if($sessionUserDetails->admin_type=='field_officer'){echo ' hide';}?>">
    ...
    echo form_open_multipart('super_admin/customerRegistration', $attributes);
    ?>
    <!--<form role="form">-->
    <div class="box-body">
		...
		<div class="form-group">
            ...
            <input type="text" autocomplete="off" name="husband_name" class="form-control">
        </div>
		<div class="form-group">
            <label for="name">পেশা</label>
            <input type="text" autocomplete="off" name="pesha" class="form-control">
        </div>

		<div class="form-group">
            <label for="name">মোবাইল</label>
            <input type="text" autocomplete="off" name="mobile_no" class="form-control">
        </div>
		<div class="form-group">
