...
<div class="box box-primary">
	...
	<div>
     ...
     <form method="POST" action="<?php echo base_url()?>super_admin/update_loan_collection" enctype="multipart/form-data">
    <div class="box-body">
<input type="hidden" name="id"  class="form-control" value="<?php echo $ac_info->id?>">

        <div class="form-group">
            <label for=""> প্রদানকৃত তারিখ ( <?php echo $ac_info->today;?> )  ( Year-Day-Month ) </label>
            <input type="text"  name="today" autocomplete="off" class="form-control datepicker">
        </div>
		<div class="form-group">
            <label for=""> গ্রহনকৃত তারিখ ( ইন্সটলমেন্ট  তারিখ-<?php echo $ac_info->installment_date;?> )  ( Month-Day-Year )</label>
        ...
        <div class="form-group">
            ...
            <input type="text" name="installment_fee"  class="form-control" value="<?php echo $ac_info->per_installment_fee?>" placeholder=" ইন্সটলমেন্ট  ফি">
        </div>
		<hr>
		<div class="form-group">
            <label for=""> সঞ্চয় ফি--Savings Money ( In English )  </label>
            <input type="text" name="soncoy" value="<?php echo $ac_info->soncoy?>"  class="form-control">
...
<div class="box">
    <div class="box-header" style="color:green">
	    <p> নাম  :<?php echo ' '. $ac_info->name ?></p>
		<p> পিতা  :<?php echo ' '. $ac_info->father_name ?></p>
		<p> গ্রাম  :<?php echo ' '. $ac_info->pa_gram ?></p>
		<p>সদস্য নং :<?php echo $ac_info->member_no ?></p>
		<p>একাউন্ট নং  :
		<?php
